...
Source0  : https://github.com/editorconfig/editorconfig-core-c/archive/v0.12.7/editorconfig-core-c-0.12.7.tar.gz
...
%prep
%setup -q -n editorconfig-core-c-0.12.7
cd %{_builddir}/editorconfig-core-c-0.12.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711976877
mkdir -p clr-build
pushd clr-build
...
%files bin
%defattr(-,root,root,-)
/V3/usr/bin/editorconfig-0.12.7
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libeditorconfig.so.0.12.7
/usr/lib64/libeditorconfig.so.0
/usr/lib64/libeditorconfig.so.0.12.7
